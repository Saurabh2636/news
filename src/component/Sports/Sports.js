...
const Sports = () => {
  ...
  useEffect(() => {
    const api =
      "https://gnews.io/api/v4/top-headlines?topic=sports&lang=hi&county=in&token=a4e7b89d3fb9419f00fc7d26b755f0ec";
    axios
      .get(api)
      .then((response) => {
  ...
  return (
    <div>
      <Header />
      <h1 style={{textAlign: 'center',color: 'white',fontSize:'3rem' }}>SportTak</h1>
